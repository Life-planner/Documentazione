...
\begin{listaPersonale} {APD}
    ...
    \begin{center}
        ...
        \blfootnote{Immagine \href{https://github.com/Life-planner/Documentazione/blob/main/D4/img/png/project_structure/project_structure_totale.png}{PNG} Struttura codice sorgente}
        \captionof{figure}{Struttura codice sorgente}
    \end{center}
    \newpage
