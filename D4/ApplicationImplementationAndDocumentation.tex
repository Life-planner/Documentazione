...
\begin{listaPersonale} {APD}
    \elemento[Project Structure]{apd:ProjecStructure}
    ...
    \begin{comment}
    \begin{figure}[h!]
        \includegraphics[width=0.25\textwidth,height=0.55\textheight]{img/png/project_structure/project_structure.png}
        \centering
        \includegraphics[width=0.25\textwidth,height=0.25\textheight]{img/png/project_structure/api.png}
    \end{figure}
    \end{comment}
    \newpage
    ...
    \end{center}
    \begin{center}
        \includegraphics[width=0.45\textwidth, height=0.15\textheight]{img/png/DB/calendario.png}
    ...
    \end{center}
    \begin{center}
        \includegraphics[width=0.45\textwidth, height=0.4\textheight]{img/png/DB/calendario_intero.png}
        \captionof{figure}{Tipo di dato "Calendario" con gli oggetti contenuti "aperti"}
        \blfootnote{Immagine \href{https://github.com/Life-planner/Documentazione/blob/main/D4/img/png/DB/calendario_intero.png}{PNG} Tipo di dato "Calendario" con gli oggetti contenuti aperti}
    \end{center}
    \begin{center}
        \includegraphics[width=0.45\textwidth, height=0.25\textheight]{img/png/DB/evento_singolo.png}
    ...
    \begin{center}
        ...
        \captionof{figure}{Tipo di dato "Evento" singolo con gli oggetti contenuti "aperti"}
        \blfootnote{Immagine \href{https://github.com/Life-planner/Documentazione/blob/main/D4/img/png/DB/evento_singolo_intero.png}{PNG} Tipo di dato "Evento" singolo con gli oggetti contenuti aperti}
    \end{center}
    \begin{center}
        \includegraphics[width=0.45\textwidth, height=0.25\textheight]{img/png/DB/evento_ripetuto.png}
    ...
    \begin{center}
        ...
        \captionof{figure}{Tipo di dato "Evento" ripetuto con gli oggetti contenuti "aperti"}
        \blfootnote{Immagine \href{https://github.com/Life-planner/Documentazione/blob/main/D4/img/png/DB/evento_ripetuto_intero.png}{PNG} Tipo di dato "Evento" ripetuto con gli oggetti contenuti aperti}
    \end{center}
    \newpage
    ...
    \begin{listaPersonale2}[APD]{}
        ...
        \begin{itemize}
            \item Partendo dalla classe "GestioneChiamateMongoDB" e dalle sue funzioni e attributi, presentati in \prettyref{D3-dcl:MongoDB}, abbiamo individuato cinque Resources, ovvero:
                  \begin{itemize}
                  ...
                  \end{itemize}
                  Si specifica che gli attributi "link", "password" e "schema" sono necessari per poter effettuare la connessione con il database MongoDB, come specificato in \prettyref{D3-dcl:MongoDB}, e tutte le resources individuate riguardano a funzioni già presentate sempre in \prettyref{D3-dcl:MongoDB}.
        ...
        \begin{listaPersonale3}[APD]{}
            ...
            \end{center}
            \elemento[Resource Models "GestioneChiamateMongoDB"]{apd:ResourcesModelGestioneChiamateMongoDB}
            ...
            \begin{center}
                ...
                \captionof{figure}{Resources Model riguardo solo "GestioneChiamateMongoDB"}
                \blfootnote{Immagine \href{https://github.com/Life-planner/Documentazione/blob/main/D4/img/png/diagrammi/Resources_Model_GestioneChiamateMongoDB.png}{PNG}/\href{https://github.com/Life-planner/Documentazione/blob/main/D4/img/svg/diagrammi/Resources_Model_GestioneChiamateMongoDB.svg}{SVG} Resources Model riguardo solo "GestioneChiamateMongoDB"}
            \end{center}
        \end{listaPersonale3}
    \end{listaPersonale2}
