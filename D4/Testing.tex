...
\begin{listaPersonale}{TS}
        ...
        \elemento [Evento - DELETE] {ts:eventoDelete}
                ...
                \end{center}
        \elemento [Evento - GET] {ts:eventiGet}
                ...
                \begin{center}
                        ...
                        \blfootnote{Immagine \href{https://github.com/Life-planner/Documentazione/blob/main/D4/img/png/tests/EventoGet/200_getEventi.png}{PNG} Casi 200, GET evento}
                        \captionof{figure}{Casi 200, GET evento}
                \end{center}
                ...
                \begin{center}
                        ...
                        \blfootnote{Immagine \href{https://github.com/Life-planner/Documentazione/blob/main/D4/img/png/tests/EventoGet/400_missingParameter_getEventi.png}{PNG} Casi 400 "Parameter missing", GET Evento}
                        \captionof{figure}{Casi 400 "Parameter missing", GET Evento}
                \end{center}
                ...
                \begin{center}
                        ...
                        \blfootnote{Immagine \href{https://github.com/Life-planner/Documentazione/blob/main/D4/img/png/tests/EventoGet/409_userId_getEventi.png}{PNG} Casi 409 riguardo "userId", GET Evento}
                        \captionof{figure}{Casi 409 riguardo "userId", GET Evento}
                \end{center}
                ...
                \begin{center}
                        ...
                        \blfootnote{Immagine \href{https://github.com/Life-planner/Documentazione/blob/main/D4/img/png/tests/EventoGet/409_getEventi.png}{PNG} Casi 409, GET Evento}
                        \captionof{figure}{Casi 409, GET Evento}
                \end{center}
        ...
        \elemento [Calendario - GET] {ts:calendariGet}
                ...
                \begin{center}
                        ...
                        \blfootnote{Immagine \href{https://github.com/Life-planner/Documentazione/blob/main/D4/img/png/tests/CalendarioGet/200_getCalendari.png}{PNG} Casi 200, GET Calendario}
                        \captionof{figure}{Casi 200, GET Calendario}
                \end{center}
                ...
                \begin{center}
                        ...
                        \blfootnote{Immagine \href{https://github.com/Life-planner/Documentazione/blob/main/D4/img/png/tests/CalendarioGet/400_getCalendari.png}{PNG} Casi 400 "Parameter missing", GET Calendario}
                        \captionof{figure}{Casi 400 "Parameter missing", GET Calendario}
                \end{center}
                ...
                \begin{center}
                        ...
                        \blfootnote{Immagine \href{https://github.com/Life-planner/Documentazione/blob/main/D4/img/png/tests/CalendarioGet/409_getCalendari.png}{PNG} Casi 409, GET Calendario}
                        \captionof{figure}{Casi 409, GET Calendario}
                \end{center}
