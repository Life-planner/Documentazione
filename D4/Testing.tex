...
\begin{listaPersonale}{TS}
        ...
        \elemento [Calendario - PUT] {ts:calendarioPut}
                ...
                \begin{center}
                        ...
                        \blfootnote{Immagine \href{https://github.com/Life-planner/Documentazione/blob/main/D4/img/png/tests/CalendarioPut/200_putCalendario.png}{PNG} Casi 200, PUT Calendario}
        ...
        \elemento [Utente - PUT] {ts:utentePut}
                ...
                \begin{center}
                        \includegraphics[width=1\textwidth, height=0.08\textheight]{img/png/tests/UtentePost/200_postUtente.png}
                        \blfootnote{Immagine \href{https://github.com/Life-planner/Documentazione/blob/main/D4/img/png/tests/UtentePost/200_postUtente.png}{PNG} Casi 200, PUT Utente}
                        \captionof{figure}{Casi 200, PUT Utente}
                \end{center}
