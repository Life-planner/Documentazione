...
\begin{center}
    ...
    \captionof{figure}{schermata "Calendario" - side-bar Calendari}
...
\begin{center}
    ...
    \captionof{figure}{schermata "Calendario" - Scelta creazione}
...
\begin{center}
    ...
    \captionof{figure}{schermata "Calendario" - Crea Calendario}
...
\begin{center}
    ...
    \captionof{figure}{schermata "Calendario" - Crea Evento}
...
\begin{center}
    ...
    \captionof{figure}{schermata "Calendario" - visualizzazione impostazioni evento}
    \blfootnote{Immagine \href{https://github.com/Life-planner/Documentazione/blob/main/D4/img/png/FrontEnd/Calendario/impostazioniEvento.png}{PNG} schermata "Calendario" - visualizzazione impostazioni evento}
\end{center}
...
\begin{center}
    ...
    \captionof{figure}{schermata "Calendario" - Andare indietro di settimane}
...
\begin{center}
    ...
    \captionof{figure}{schermata "Eventi" - "Crea Calendario"}
    \blfootnote{Immagine \href{https://github.com/Life-planner/Documentazione/blob/main/D4/img/png/FrontEnd/Eventi/EventiCreaCalendario.png}{PNG} schermata "Eventi" - "Crea Calendario" }
\end{center}

\begin{center}
    \includegraphics[width=1\textwidth, height=0.3\textheight]{img/png/FrontEnd/Eventi/EventiCreaEvento.png}
    \captionof{figure}{schermata "Eventi" - "Crea Evento"}
    \blfootnote{Immagine \href{https://github.com/Life-planner/Documentazione/blob/main/D4/img/png/FrontEnd/Eventi/EventiCreaEvento.png}{PNG} schermata "Eventi" - "Crea Evento"}
\end{center}
...
\begin{center}
    ...
    \captionof{figure}{schermata "Eventi" - "Modifica Evento"}
    \blfootnote{Immagine \href{https://github.com/Life-planner/Documentazione/blob/main/D4/img/png/FrontEnd/Eventi/EventiModificaEvento.png}{PNG} schermata "Eventi" - "Modifica Evento"}
\end{center}
\newpage
...
\begin{center}
    ...
    \captionof{figure}{schermata "Eventi" - "Modifica Calendario"}
    \blfootnote{Immagine \href{https://github.com/Life-planner/Documentazione/blob/main/D4/img/png/FrontEnd/Eventi/EventiModificaCalendario.png}{PNG} schermata "Eventi" - "Modifica Calendario"}
\end{center}