...
\begin{enumerate}
    ...
    \item Il sistema di posta elettronica, email sarà utilizzato per inviare email informative sul sito ed email relative a comunicazioni per l'utente standard, ovvero:
          \begin{itemize}
