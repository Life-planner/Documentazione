...
\begin{listaPersonale}{RNF}
    ...
    \begin{listaPersonale2}[RNF]{}
        \elemento{rnf:SicurezzaPassword} in caso un cliente avesse deciso di registrarsi tramite credenziali (quindi decidendo di non utilizzare sistemi esterni come Google), il cliente deve avere una password ed email decisa obbligatoriamente dagli utenti in fase di registrazione. La password deve seguire degli standard, ovvero avere almeno:
        \begin{itemize}
            \item otto caratteri;
