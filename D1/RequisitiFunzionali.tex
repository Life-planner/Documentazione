...
\elemento[GESTIONE DI CALENDARI]{rf:CondivisioneCalendario} Il sistema darà la possibilità di condividere il proprio calendario su più dispositivi (\ref{ob:CalendariMultipli}).
...
\elemento{rf:PreferenzeServiziTerzePartiAccount} impostare preferenze e interazioni con servizi di terze parti (\hyperref[rf:LuogoEvento]{RF5.5});
