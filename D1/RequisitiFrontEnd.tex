...
\begin{listaPersonale}{FE}
    ...
    \begin{figure}[H]
        \centering
        \href{https://www.figma.com/proto/cO66hx25OizBABGtWp8XlT/Planify?node-id=25%3A82&scaling=scale-down&page-id=0%3A1&starting-point-node-id=25%3A82}{\includegraphics[width=0.95\textwidth]{img/FrontEnd/Calendar/CalendarCondivisi.png}}
    \end{figure}
    ...
    \begin{figure}[H]
        \centering
        \href{https://www.figma.com/proto/cO66hx25OizBABGtWp8XlT/Planify?node-id=84%3A178&scaling=scale-down&page-id=0%3A1&starting-point-node-id=25%3A82}{\includegraphics[width=0.95\textwidth]{img/FrontEnd/Dashboard/Dashboard.png}}
    \end{figure}
    ...
    \begin{listaPersonale2}{FE}
        ...
        \blfootnote{Immagine \href{https://github.com/Life-planner/Documentazione/blob/main/D1/img/FrontEnd/Dashboard/selezionatoAttivita.png}{PNG} grafico attività svolte}
        \begin{figure}[H]
            \centering
            \href{https://www.figma.com/proto/cO66hx25OizBABGtWp8XlT/Planify?node-id=84%3A178&scaling=scale-down&page-id=0%3A1&starting-point-node-id=25%3A82}{\includegraphics[width=0.72\textwidth,height=0.2\textheight]{img/FrontEnd/Dashboard/selezionatoAttivita.png}}
    ...
    \begin{listaPersonale2}{FE}
        ...
        \begin{figure}[!ht]
            \href{https://www.figma.com/proto/cO66hx25OizBABGtWp8XlT/Planify?node-id=160%3A290&scaling=scale-down&page-id=0%3A1&starting-point-node-id=25%3A82}{\includegraphics[width=0.48\textwidth,height=0.35\textheight]{img/FrontEnd/Eventi/Evento/CreaEvento.png}}
            \centering
        ...
        \blfootnote{Immagine \href{https://github.com/Life-planner/Documentazione/blob/main/D1/img/FrontEnd/Eventi/Evento/ModificaEvento.png}{PNG} schermata modifica evento}


        \elemento[SCHERMATA CREA EVENTO RIPETUTO/ CREA EVENTO RIPETUTO IMPOSTAZIONI AVANZATE]{fe:SchermataCreaEventoRipetuto}
        \begin{figure}[!ht]
            \href{https://www.figma.com/proto/cO66hx25OizBABGtWp8XlT/Planify?node-id=160%3A290&scaling=scale-down&page-id=0%3A1&starting-point-node-id=25%3A82}{\includegraphics[width=0.48\textwidth,height=0.35\textheight]{img/FrontEnd/Eventi/EventoRipetuto/CreaEventoRipetuto.png}}
            \centering
        ...
        \begin{figure}[!ht]
            \href{https://www.figma.com/proto/cO66hx25OizBABGtWp8XlT/Planify?node-id=160%3A290&scaling=scale-down&page-id=0%3A1&starting-point-node-id=25%3A82}{\includegraphics[width=0.48\textwidth,height=0.35\textheight]{img/FrontEnd/Eventi/EventoRipetuto/ModificaEventoRipetuto.png}}
            \centering
        ...
        \end{figure}
        \blfootnote{Immagine \href{https://github.com/Life-planner/Documentazione/blob/main/D1/img/FrontEnd/Eventi/EventoRipetuto/ModificaEventoRipetuto.png}{PNG} schermata modifica evento ripetuto}
        ...
        \end{figure}
        \blfootnote{Immagine \href{https://github.com/Life-planner/Documentazione/blob/main/D1/img/FrontEnd/Eventi/Calendario/CreaCalendario1.png}{PNG} schermata crea calendario}
