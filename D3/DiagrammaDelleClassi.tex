...
\begin{listaPersonale}{DCL}
    ...
    \begin{center}
        \includesvg[width=0.9\textwidth, height=1\textheight]{img/svg/DCL/Tipologie_Utenti.svg}
    ...
    \begin{center}
        \includesvg[width=0.9\textwidth,height=1\textheight]{img/svg/DCL/Impostazioni_Utente.svg}
    ...
    \begin{listaPersonale2}[DCL]{}
        ...
        \begin{center}
            \includesvg[width=0.87\textwidth,height=0.85\textheight]{img/svg/DCL/Abbonamento.svg}
        ...
        \begin{center}
            \includesvg[width=0.85\textwidth,height=1\textheight]{img/svg/DCL/Gestione_pagamento.svg}
    ...
    \begin{center}
        \includesvg[width=0.9\textwidth,height=1\textheight]{img/svg/DCL/VisualizzazioneCalendario.svg}
    ...
    \begin{center}
        \includesvg[width=0.9\textwidth,height=1\textheight]{img/svg/DCL/GestioneEventoCalendario.svg}
    ...
    \begin{listaPersonale2}[DCL]{}
        ...
        \begin{center}
            \includesvg[width=0.85\textwidth,height=1\textheight]{img/svg/DCL/CreazioneModificaCalendario.svg}
        ...
        \begin{center}
            \includesvg[width=0.87\textwidth,height=0.80\textheight]{img/svg/DCL/CreazioneModificaEvento.svg}
    ...
    \begin{center}
        \includesvg[width=0.9\textwidth,height=1\textheight]{img/svg/DCL/Homapage.svg}
    ...
    \elemento[Diagramma delle classi complessivo] {dcl:DiagrammaComplessivo}
        ...
        \begin{itemize}
            ...
            \item Il terzo grafico riportato mostra le classi che gestiscono l' "Homepage".
            \item Il quarto grafico riportato mostra le classi che gestiscono l' interfaccia di Iubenda.
            \item Il quinto grafico riportato mostra dei tipi di dati usati nelle classi
        \end{itemize}
        \begin{center}
            \includesvg[width=0.9\textwidth,height=1\textheight]{img/svg/DCL/GraficoComplessivo/GraficoTotale.svg}
        ...
        \newpage
        \begin{center}
            \includesvg[width=0.9\textwidth,height=1\textheight]{img/svg/DCL/GraficoComplessivo/complessivo_1.svg}
        ...
        \end{center}
        \begin{center}
            \includesvg[width=0.9\textwidth,height=1\textheight]{img/svg/DCL/GraficoComplessivo/AltoSx.svg}
        ...
        \end{center}
        \begin{center}
            \includesvg[width=0.9\textwidth,height=1\textheight]{img/svg/DCL/GraficoComplessivo/TipiDiDati.svg}
