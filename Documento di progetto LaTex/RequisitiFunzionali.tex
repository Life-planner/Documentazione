...
\elemento[OMPILAZIONE EVENTO]{rf:5}
...
\begin{listaPersonale2}{RF}
	\elemento{rf:5.1} di imporre restrizioni, per esempio definire ora e giorno dell’attività da svolgere; 
	...
	più giorni. 
\elemento{rf:5.5} L’utente avrà la possibilità di impostare le ore di sonno giorno per giorno oppure applicare le stesse ore per più giorni.
\end{itemize}
...
\elemento[INTERAZIONE con Google Maps]{rf:8.2}
