...
\begin{listaPersonale}{RF}
	...
	\begin{listaPersonale2}{}
		...
		\elemento {rf:5.8} di poter aggiungere l'evento ad un raggruppamento di altre attività.
	\end{listaPersonale2}
