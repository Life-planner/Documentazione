...
\begin{listaPersonale}{FE}
    ...
    \begin{figure}[H]
        \centering
        \href{https://www.figma.com/proto/cO66hx25OizBABGtWp8XlT/Planify?node-id=25%3A82&scaling=scale-down&page-id=0%3A1&starting-point-node-id=25%3A82}{\includegraphics[width=1\textwidth,height=0.35\textheight]{img/FrontEnd/Calendar/CalendarCondivisi.png}}
    \end{figure}
