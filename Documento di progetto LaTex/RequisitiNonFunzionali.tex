...
\begin{listaPersonale}{RNF}
    ...
    \elemento[PRESTAZIONI]{rnf:5} Il sito dovrà presentare almeno un punteggio di 85\% durante la valutazione delle prestazioni(\ref{ob:14}) mediante l'utilizzo dello strumento “lighthouse” di Google Chrome.
