...
\begin{listaPersonale}{RNF}
    ...
    \begin{listaPersonale2}{}
        \elemento {rnf:2.1} avere, come primo livello di sicurezza, una password decisa obbligatoriamente dagli utenti in fase di registrazione. La password deve seguire degli standard, ovvero avere almeno: 
        \begin{itemize}
            \item 8 caratteri;
