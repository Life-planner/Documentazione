...
\begin{listaPersonale}{RNF}
    ...
    \begin{listaPersonale2}{}
        \elemento {rnf:2.1} avere, come primo livello di sicurezza, una password ed email decisa obbligatoriamente dagli utenti in fase di registrazione. La password deve seguire degli standard, ovvero avere almeno: 
        \begin{itemize}
            \item 8 caratteri;
    ...
    \begin{listaPersonale2}{}
        \elemento{rnf:8.1} sistemi di mappe, vale a dire Google Maps e OpenStreetMap;
        \elemento{rnf:8.2} sistemi di pagamento, vale a dire PayPal e Stripe;
        \elemento{rnf:8.3} sistemi di autenticazione, vale a dire Auth0; % prima questi servizi di terze parti non erano specificati, non so perché. GL
        \elemento{rnf:8.4} Google Calendar.
    \end{listaPersonale2}
