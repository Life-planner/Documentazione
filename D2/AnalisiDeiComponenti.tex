...
\begin{listaPersonale}[ACI]{}
    ...
    \textbf{Motivazione:}\\
    Il sistema deve permettere all'utente di autenticarsi con l'uso di credenziali o con accesso mediante software esterni quali Google (\prettyref{D1-rf:MetodiAutenticazione}), per questo motivo è stato definito questo componente.
    ...
    \elemento[Interfaccia Cloudflare]{aci:ClaudFlare}
    \textbf{Motivazione:}\\
...
\begin{listaPersonale}[]{}
    \elemento[Gestione creazione o modifica evento]{}
    ...
    \elemento[Interfaccia sistema di mappe]{}
    ...
    \elemento[Gestione condivisione]{}
    ...
    \elemento[Gestione campi precompilati]{}
    ...
    \elemento[Gestione creazione e modifica calendario]{}
    ...
    \elemento[Gestione eventi settimanali]{}
    ...
    \elemento[Gestione eventi giornalieri]{}
    ...
    \elemento[Gestione impostazioni account]{}
    ...
    \elemento[Gestione modifica password]{}
    ...
    \elemento[Interfaccia API Auth0]{}
    ...
    \elemento[Gestione utilizzo Google Calendar]{}
    ...
    \elemento[Gestione import/export attraverso file]{}
    ...
    \elemento[Gestione visualizzazione calendari ed eventi]{}
    ...
    \elemento[Gestione filtri calendari]{}
    ...
    \elemento[Gestione filtri impegni]{}
    ...
    \elemento[Gestione mostra informazioni evento]{}
    ...
    \elemento[Gestione metodo di pagamento]{}
    ...
    \elemento[Gestione chiamate MongoDB]{}
