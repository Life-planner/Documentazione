...
\begin{center}
    ...
    \blfootnote{\href{https://github.com/Life-planner/Documentazione/blob/main/D2/img/Diagrammi/Componenti/Diagramma_dei_componenti.png}{Immagine diagramma dei componenti}}
...
\begin{center}
    ...
    \blfootnote{\href{https://github.com/Life-planner/Documentazione/blob/main/D2/img/Diagrammi/Componenti/P1_Diagramma_dei_componenti.png}{Immagine diagramma dei componenti P1}}
...
\begin{center}
    ...
    \blfootnote{\href{https://github.com/Life-planner/Documentazione/blob/main/D2/img/Diagrammi/Componenti/P2_Diagramma_dei_componenti.png}{Immagine diagramma dei componenti P2}}
    Questa figura mostra tutto il quarto in alto a destra del diagramma dei componenti del sito PlanIt.
\end{center}
\begin{center}
    \includegraphics[width=1\textwidth,height=0.45\textheight]{img/Diagrammi/Componenti/P3_Diagramma_dei_componenti.png}\\
    \blfootnote{\href{https://github.com/Life-planner/Documentazione/blob/main/D2/img/Diagrammi/Componenti/P3_Diagramma_dei_componenti.png}{Immagine diagramma dei componenti P3}}
    Questa figura mostra tutto il quarto in basso a destra del diagramma dei componenti del sito PlanIt.
\end{center}
\begin{center}
    \includegraphics[width=1\textwidth,height=0.45\textheight]{img/Diagrammi/Componenti/P4_Diagramma_dei_componenti.png}\\
    \blfootnote{\href{https://github.com/Life-planner/Documentazione/blob/main/D2/img/Diagrammi/Componenti/P4_Diagramma_dei_componenti.png}{Immagine diagramma dei componenti P4}}
