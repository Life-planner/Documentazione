...
\begin{listaPersonale}{UC}
    ...
    \begin{center}
        \blfootnote{\href{https://github.com/Life-planner/Documentazione/blob/main/D2/img/Diagrammi/UseCases/AccessoRegistrazione.png}{Immagine use case Accesso e registrazione}}
    ...
    \textbf{Diagramma:}
    \begin{center}
        \blfootnote{\href{https://github.com/Life-planner/Documentazione/blob/main/D2/img/Diagrammi/DS/DS_AccessoRegistrazione.png}{Immagine diagramma Accesso e registrazione}}
    ...
    \begin{center}
        \blfootnote{\href{https://github.com/Life-planner/Documentazione/blob/main/D2/img/Diagrammi/UseCases/FunzionalitaUtenti.png}{Immagine use case funzionalità utenti}}
    ...
    \begin{center}
        \blfootnote{\href{https://github.com/Life-planner/Documentazione/blob/main/D2/img/Diagrammi/UseCases/CondivisioneCalendario.png}{Immagine use case condivisione calendario}}
    ...
    \begin{center}
        \blfootnote{\href{https://github.com/Life-planner/Documentazione/blob/main/D2/img/Diagrammi/UseCases/CreazioneModificaEvento.png}{Immagine use case creazione/modifica evento}}
    ...
    \begin{center}
        ...
        \blfootnote{\href{https://github.com/Life-planner/Documentazione/blob/main/D2/img/Diagrammi/DS/DS_CreazioneModificaEvento.png}{Immagine diagramma creazione/modifica evento}}
    ...
    \begin{center}
        \blfootnote{\href{https://github.com/Life-planner/Documentazione/blob/main/D2/img/Diagrammi/UseCases/InserimentoAutomaticoCalendario.png}{Immagine use case organizzazione attivita}}
    ...
    \begin{center}
        \blfootnote{\href{https://github.com/Life-planner/Documentazione/blob/main/D2/img/Diagrammi/UseCases/ResocontoGiornata.png}{Immagine use case resoconto giornata}}
    ...
    \begin{center}
        \blfootnote{\href{https://github.com/Life-planner/Documentazione/blob/main/D2/img/Diagrammi/UseCases/Notifiche.png}{Immagine use case notifiche}}
    ...
    \begin{center}
        \blfootnote{\href{https://github.com/Life-planner/Documentazione/blob/main/D2/img/Diagrammi/UseCases/UsoDelTempo.png}{Immagine use case uso del tempo}}
    ...
    \begin{center}
        \blfootnote{\href{https://github.com/Life-planner/Documentazione/blob/main/D2/img/Diagrammi/UseCases/Filtro.png}{Immagine use case filtro impegni}}
    ...
    \begin{center}
        \blfootnote{\href{https://github.com/Life-planner/Documentazione/blob/main/D2/img/Diagrammi/UseCases/ImpostazioniPredefiniteCalendario.png}{Immagine use case creazione o modifica di un calendario}}
    ...
    \begin{center}
        \blfootnote{\href{https://github.com/Life-planner/Documentazione/blob/main/D2/img/Diagrammi/UseCases/ImpostazioniAccount.png}{Immagine use case impostazioni account}}
    ...
    \begin{center}
        ...
        \blfootnote{\href{https://github.com/Life-planner/Documentazione/blob/main/D2/img/Diagrammi/DS/DS_ImpostazioneAccount.png}{Immagine diagramma impostazioni account}}
    ...
    \begin{listaPersonale2}[UC] {}
        ...
        \begin{center}
            \blfootnote{\href{https://github.com/Life-planner/Documentazione/blob/main/D2/img/Diagrammi/UseCases/UtentePremium.png}{Immagine use case sottoscrizione account premium}}
        ...
        \begin{center}
            \blfootnote{\href{https://github.com/Life-planner/Documentazione/blob/main/D2/img/Diagrammi/UseCases/GoogleCalendar.png}{Immagine use case Google Calendar}}
    ...
    \begin{center}
        \blfootnote{\href{https://github.com/Life-planner/Documentazione/blob/main/D2/img/Diagrammi/UseCases/RecuperoPassword.png}{Immagine use case recupero password}}
    ...
    \textbf{Diagramma:}
    \begin{center}
        \blfootnote{\href{https://github.com/Life-planner/Documentazione/blob/main/D2/img/Diagrammi/DS/DS_RecuperoPassword.png}{Immagine diagramma recupero password}}
