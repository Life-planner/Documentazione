...
\begin{listaPersonale}{UC}
    ...
    \textbf{Diagramma:}
    \begin{center}
        \includesvg[width=0.9\textwidth]{img/Diagrammi/svg/DS/DS_CreazioneModificaEvento.svg}
    ...
    \begin{center}
        \blfootnote{Immagine \href{https://github.com/Life-planner/Documentazione/blob/main/D2/img/Diagrammi/png/UseCases/InserimentoAutomaticoCalendario.png}{PNG}/\href{https://github.com/Life-planner/Documentazione/blob/main/D2/img/Diagrammi/svg/UseCases/InserimentoAutomaticoCalendario.svg}{SVG} use case organizzazione attività}
    ...
    \begin{enumerate}[label=\textbf{[extension \arabic{enumii}]}, ref= \textbf{[extension \arabic{enumii}]}]
        ...
        \elemento{uc:ExtensionVisualizzazioneAttivita} Mettendo il cursore sopra a una delle attività della lista, l'utente non autenticato visualizza evidenziata tale attività nel grafico a torta.
    \end{enumerate}
    ...
    \begin{center}
        ...
        \includesvg[width=0.9\textwidth]{img/Diagrammi/svg/UseCases/ImpostazioniPredefiniteCalendario.svg}
    \end{center}
    ...
    \textbf{Diagramma:}
    \begin{center}
        \includesvg[width=0.9\textwidth]{img/Diagrammi/svg/DS/DS_ImpostazioneAccount.svg}\\
    ...
    \begin{listaPersonale2}[UC] {}
        ...
        \begin{center}
            ...
            \includesvg[width=0.87\textwidth]{img/Diagrammi/svg/UseCases/GoogleCalendar.svg}
        \end{center}
