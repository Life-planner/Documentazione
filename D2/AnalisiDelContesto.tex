...
\begin{listaPersonale}{DCO}
    ...
    \begin{center}
        ...
        \blfootnote{\href{https://github.com/Life-planner/Documentazione/blob/main/D2/img/Diagrammi/Contesto/DiagrammaContesto.png}{Immagine diagramma del contesto}}
